 ...
 * @author user
 */
public class EditChasove extends javax.swing.JFrame {

    /**
     * Creates new form EditChasove
     */
    public EditChasove() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblChasove.setText("Въведете нов брой часове");
    ...
    public void setLblTeacherOrStudent(String label){
        ...
        if (label.equals("Изберете учител"))
        {
    ...
    public static void Run() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditChasove.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditChasove().setVisible(true);
            }
        });
    }
