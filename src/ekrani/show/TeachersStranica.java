...
public class TeachersStranica extends javax.swing.JFrame {
    ...
    private void btnEnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnterActionPerformed
        for (Teacher teacher : School.teachers) {
            if (teacher.getName().equals(cbbTeacher.getSelectedItem())) {
                new DisplaySchedule(School.getStudent(cbbTeacher.getSelectedItem() + "").getArr()).setVisible(true);
                dispose();
                break;
            }
        }
    ...
    public static void Run(){
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeachersStranica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
